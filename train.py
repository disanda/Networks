...
##核心## 
#网络结构G，参数(3,3,64,'batch', False, 'normal', 0.02, gpu_id=device)
#网络D的输入第一参数为6，因为是两个图片各3个通道拼起来
...
#batch里面是一对图片real_a是mask,real_b是真图片,fake_b是假图片
